...
<li class="nav-item">
<a class="nav-link" href="pos.php"><i class="fas fa-cash-register me-2"></i>New Sale</a>
</li>
<li class="nav-item">
<a class="nav-link" href="sales_history.php"><i class="fas fa-receipt me-2"></i>Sales History</a>
</li>
<li class="nav-item">
<a class="nav-link" href="payments.php"><i class="fas fa-hand-holding-dollar me-2"></i>Utang / AR</a>
</li>
<li class="nav-item">
