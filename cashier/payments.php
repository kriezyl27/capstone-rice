...
<li class="nav-item">
<a class="nav-link active" href="payments.php"><i class="fas fa-hand-holding-dollar me-2"></i>Utang Payments</a>
</li>
<li class="nav-item">
...
<li class="nav-item">
<a class="nav-link" href="inventory_view.php"><i class="fas fa-boxes-stacked me-2"></i>Inventory View</a>
</li>
</ul>
</div>
</nav>
